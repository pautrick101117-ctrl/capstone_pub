...
const Officials = () => {
  ...
  return (
    <section className="section-shell py-10 sm:py-14">
      <PageHeader eyebrow="Public Directory" title="Barangay Officials" description="Meet the officials currently serving Barangay Iba, including their positions, terms and available public contact information." />
