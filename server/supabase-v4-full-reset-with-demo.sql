-- =========================================================
-- BARANGAY IBA PORTAL V4 - FULL RESET + DEMO DATA
-- DESTRUCTIVE: drops/recreates portal data. Use only for a fresh demo database.
-- Generated from the current V3 reset/seed + V4 migration + V4 demo extension.
-- =========================================================
