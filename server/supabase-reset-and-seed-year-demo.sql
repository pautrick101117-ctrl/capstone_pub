-- Barangay Iba FULL RESET + ONE-YEAR DEMO DATA
-- WARNING: DESTRUCTIVE. This truncates all Barangay Iba application tables in public,
-- then seeds a full demo environment with 100 resident accounts and one year of history.
-- Run server/supabase-security-voting-migration.sql FIRST.
--
-- Admin login: admin@gmail.com / Password123
-- Resident logins: resident001@example.com ... resident100@example.com / Password123
-- resident001 is intentionally left eligible/not-yet-voted in the current live election for testing.
-- All identities and contact details are fictional demo data.
